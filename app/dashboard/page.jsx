    ...
    <div className="w-full">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {[1, 2, 3].map((i) => (
            <div key={i} className="bg-surface p-6 md:p-8 rounded-[24px] border border-border shadow-sm h-[170px] relative overflow-hidden group">
        ...
        >
          {/* Total Prompts Card */}
          <motion.div variants={itemVariants} className="bg-surface p-6 md:p-8 rounded-[24px] border border-border shadow-sm group hover:border-primary/30 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:hover:shadow-none transition-all duration-300 relative overflow-hidden">
          ...
          <motion.div variants={itemVariants} className="bg-surface p-6 md:p-8 rounded-[24px] border border-border shadow-sm group hover:border-accent/30 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:hover:shadow-none transition-all duration-300 relative overflow-hidden">
          ...
          {/* Account Status Card */}
          <motion.div variants={itemVariants} className="bg-surface p-6 md:p-8 rounded-[24px] border border-border shadow-sm group hover:border-border transition-all duration-300 relative overflow-hidden">
            {isPremium && (
