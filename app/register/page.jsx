...
import { Mail, Lock, User, UserPlus, Eye, EyeOff, Loader2, Image as ImageIcon } from 'lucide-react';
...
function RegisterForm() {
  ...
  // 1. Added photoURL to initial state
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      // 2. Passed formData.photoURL instead of empty string
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 relative overflow-hidden bg-background">
      ...
      <div className="absolute top-0 right-1/4 w-[500px] h-[500px] bg-primary/10 rounded-full blur-[120px] pointer-events-none -z-10 mix-blend-multiply dark:mix-blend-lighten"></div>
      <div className="absolute bottom-0 left-1/4 w-[500px] h-[500px] bg-accent/10 rounded-full blur-[120px] pointer-events-none -z-10 mix-blend-multiply dark:mix-blend-lighten"></div>
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-text-secondary text-center mb-8 font-medium">Join PromptNest and unlock the power of AI creativity.</p>
          
          <form onSubmit={handleSubmit} className="space-y-4 mb-8">
            {/* Full Name */}
            <div className="relative group">
              <User className="absolute left-4 top-1/2 -translate-y-1/2 text-text-secondary group-focus-within:text-primary transition-colors duration-300" size={20} />
              <input 
                required 
                type="text" 
            ...
            {/* 3. Added Profile Image URL Field */}
            <div className="relative group">
              <ImageIcon className="absolute left-4 top-1/2 -translate-y-1/2 text-text-secondary group-focus-within:text-primary transition-colors duration-300" size={20} />
              <input 
                required 
                type="url" 
          ...
          <div className="relative mb-8">
            ...
            <div className="relative flex justify-center text-xs font-bold">
              <span className="bg-surface px-4 text-text-secondary tracking-widest uppercase">Or sign up with</span>
            </div>
          </div>
