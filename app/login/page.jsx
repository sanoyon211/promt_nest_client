  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12 relative">
      ...
      <div className="bg-surface border border-foreground/10 p-8 rounded-3xl w-full max-w-md shadow-2xl relative overflow-hidden">
        ...
        <p className="text-foreground/60 text-center mb-8 text-sm">Log in to access your dashboard and saved prompts.</p>
        ...
        <button onClick={handleGoogleLogin} className="w-full bg-background border border-foreground/10 text-foreground font-bold py-3 rounded-xl hover:bg-foreground/5 transition-colors flex items-center justify-center">
